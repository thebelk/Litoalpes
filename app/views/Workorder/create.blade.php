                                                    ...
                                                    <div class="row"  align="justify">
                                                        ...
                                                        <div class="col-xs-6">
                                                            <div class='form-group form-register' align="justify">
                                                                ...
                                                                {{ Form::text('no_orden', null, array('placeholder' => 'Trabajo', 'class' => 'form-control')) }}
                                                            </div>
                                                        </div>
                                                        <div class="col-xs-6">
                                                            <div class='form-group form-register' align="justify">
                                                        ...
                                                        <div class="col-xs-3">
                                                            <div class='form-group form-register'>
                                                                {{ Form::checkbox('tipo_orden',  1, false)}}
                                                                {{ Form::label('tipo_orden', ' SERVICIO') }}                                                           
                                                                {{ Form::select('tipo_orden',array('1' => 'Seleccionar', '2' => 'Numerado','3' => 'Perforado','4' => 'Argollado','5' => 'Egrapado','6' => 'Levante','7' => 'Grafado','8' => 'Laminado'),null ,array('class' => 'form-control')); }}
                                                            </div>
                                                        </div>
                                                        <div class="col-xs-3">
                                                            <div class='form-group form-register'>
                                                                {{ Form::checkbox('tiro_retiro',  1, false)}}
                                                                {{ Form::label('tipo_orden', ' SUBLIMACIÓN ') }}                                                            
                                                                {{ Form::select('tipo_orden',array('1' => 'Seleccionar', '2' => 'Mugs','3' => 'Plato','4' => 'Camiseta','5' => 'Gorra'),null ,array('class' => 'form-control')); }}
                                                            </div>
                                                        </div>
                                                        <div class="col-xs-3">
                                                            <div class='form-group form-register'>
                                                                {{ Form::checkbox('tiro_retiro',  1, false)}}
                                                                {{ Form::label('tipo_orden', ' SELLO') }}                                                            
                                                                {{ Form::select('tipo_orden',array('1' => 'Seleccionar', '2' => 'Cyrel','3' => ' Sello Seco','4' => 'Sello Madera','4' => 'Sello Printer','4' => 'Sello de Bolsillo'),null ,array('class' => 'form-control')); }}
                                                            </div>
                                                            <br> 
                                                        </div>
                                                        <div class="col-xs-3">
                                                            <div class='form-group form-register'>
                                                                {{ Form::checkbox('tiro_retiro',  1, false)}}
                                                                {{ Form::label('tipo_orden', ' GIGANTOGRAFÍA') }}
                                                                {{ Form::select('tipo_orden',array('1' => 'Seleccionar', '2' => 'Banner','3' => 'Vinilo Blanco','4' => 'Traslucido','5' => 'Microperforado','6' => 'Acrílico'),null ,array('class' => 'form-control')); }}
                                                            </div>
                                                            <br>
                                                        </div>
                                                        <br>
                                                ...
                                                <div class="row"  align="justify">                                        
                                                    ...
                                                    <div class="col-xs-3">
                                                        <div class='form-group form-register'>
                                                            ...
                                                            {{ Form::label('tipo_elaborado', 'PLANCHA') }}                                                        
                                                            {{ Form::select('tipo_elaborado',array('1' => 'Seleccionar', '2' => 'Ctp 52', '3' => 'M.Doble Carta'),null ,array('class' => 'form-control')); }}
                                                        </div>                                                  
                                                    </div>
                                                    <div class="col-xs-3">
                                                        <div class='form-group form-register'>
                                                            {{ Form::checkbox('plastificadomate',  1, false)}}
                                                            {{ Form::label('tipo_elaborado', 'MASTER') }}                                                        
                                                            {{ Form::select('tipo_elaborado',array('1' => 'Seleccionar', '2' => 'Medio Master', '3' => 'Master Entero'),null ,array('class' => 'form-control')); }}
                                                        </div>
                                                        <br>
                                                    </div>
                                                    ...
                                                    <div class="row"  align="justify"> 
                                                        ...
                                                        <div class="col-xs-4">
                                                            <div class='form-group form-register'>
                                                                {{ Form::label('autorizado_diseño', 'REVISADO:') }}
                                                                {{ Form::text('autorizado_diseño', null, array('placeholder' => 'Correcciones', 'class' => 'form-control')) }}
                                                            </div>                                                
                                                        </div>
                                                        <div class="col-xs-4">
                                                            <div class='form-group form-register'>
