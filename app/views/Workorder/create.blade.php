                                ...
                                <article class="media">                               
                                    <div class="panel  panel-default">                                           
                                        <div class="row"  align="justify">
                                            ...
                                            <div class="col-xs-6 col-md-6 imp">
                                                <div class='form-group form-register'>
                                                    ...
                                                    {{ Form::select('tipo_orden',array('1' => 'Seleccionar', '2' => 'Servicio','3' => 'Producto'),null ,array('class' => 'form-control','required' => 'required')); }}
                                                </div>
                                            </div>
                                            <div class="col-xs-6 col-md-6 imp">
                                        ...
                                        <center>
                                            ...
                                            {{ Form::button('Guardar', array('type' => 'ordenproducion', 'class' => 'btn  btn-success ')) }}                               
                                        </center>
                                        <br><br>
                                    </div>
